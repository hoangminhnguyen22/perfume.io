            ...
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    ...
                    <div class="breadcrumb__option">
                        <a href="#">Home</a>
                        <a href="#">{{$Product_details->category->name}}</a>
                ...
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large"
                            src="{{URL::asset('uploads')}}/{{$Product_details->images}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price">{{number_format($Product_details->price)}}VND</div>
                    
                    
                    <a href="{{route('cart.add',['id'=>$Product_details->id])}}" class="primary-btn">ADD TO CARD</a>
                    
                    <ul>
                        <li><b>Availability</b> <span>In Stock</span></li>
                        <li><b>Shipping</b> <span>01 day shipping. <samp>Free pickup today</samp></span></li>
                        <li><b>Capacity</b> <span>100 ml</span></li>
                        <li><b>Share on</b>
                            <div class="share">
